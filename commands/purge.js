module.exports.run = async (bot, message, args) => {
	async function purge() {
		message.delete()
		if (
			!message.member.roles.find(role => role.name === 'BOTS') &&
		...
		console.log(
			fetched.size + ' mensagens encontradas a apagar'
		)
...
module.exports.config = {
	...
	alias: 'limpar',
	description:
		'Este comando serve para limpar conteúdo do chat em **N** linhas'
}
